...
import '../widgets/word_item/word_item.dart';
import '../widgets/help_button.dart';
import '../services/notification_service.dart';
import 'providers/area_screen_provider.dart';
...
class AreaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<FingerAnimationProvider>(
      create: (context) => FingerAnimationProvider(),
      builder: (context, value) => BaseScaffold(
        showLeaf: true,
        withPadding: false,
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            flexibleSpace: ScoreBar(
              ...
              showLevel: true,
              prevScreen: 'Level',
              changeAnimationStatusCallBack: () =>
                  Provider.of<FingerAnimationProvider>(
                context,
                listen: false,
              ).isFingerAnimationPlaying = !context
                      .read<FingerAnimationProvider>()
                      .isFingerAnimationPlaying,
            ),
            backgroundColor: Colors.transparent,
          ),
